...
function create_posttype() {
    ...
    $media_labels_tipo_pub = array(
        'name' => _x( 'Tipo de Publicación', 'Tipos de Publicación' ),
        'singular_name' => _x( 'Item de tipo', 'item de tipo' ),
        'search_items' =>  __( 'Buscar Tipos de Publicación' ),
        'all_items' => __( 'Todos los Tipos' ),
        'parent_item' => __( 'Tipo Padre' ),
        'parent_item_colon' => __( 'Tipo de Publicación:' ),
        'edit_item' => __( 'Editar tipo' ), 
        'update_item' => __( 'Actualizar Tipo' ),
        'add_new_item' => __( 'Adicionar Tipo' ),
        'new_item_name' => __( 'Nuevo Tipo' ),
        'menu_name' => __( 'Tipos de Publicación' ),
    ); 

    register_taxonomy('publicacion',array('inmueble'), array(
        'hierarchical' => true,
        'labels' => $media_labels_tipo_pub,
        'show_ui' => true,
        'show_admin_column' => true,
        'show_in_rest' => true,
        'rest_base' => 'tipos',
