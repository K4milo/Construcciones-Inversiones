...
?>
    <article role="article" id="post_<?php the_ID()?>" <?php post_class()?>>
        ...
        <section>
            ...
            <div class="content-wrapper col-md-4">
                ...
                <div class="social-share">
					...
					<div class="wp">
							<a class="whatsapp-movil" href="whatsapp://send/?phone=573125083128&text="><img src="<?php bloginfo('template_url');?>/images/icons/wp.png" alt="whatsapp" width="40px" height="auto"></a>

						<a class="whatsapp-web" href="https://web.whatsapp.com/send/?phone=573125083128&text="><img src="<?php bloginfo('template_url');?>/images/icons/wp.png" alt="whatsapp" width="40px" height="auto"></a>
						</div>
                </div>
            </div>
		...
		<div class="container-fliud">
				<?php if($video): ?>
		<iframe width="100%" height="500px" src="https://www.youtube.com/embed/<?php  echo $video; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		      <?php endif; ?>
		</div>
